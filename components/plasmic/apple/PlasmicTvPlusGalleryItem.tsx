...
import sty from "./PlasmicTvPlusGalleryItem.module.css"; // plasmic-import: reYjxqom29cm/css

import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: rZ57D6Up3LE9/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vVcH7)}
      >
        <Button
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__c8Tpt)}
        >
          <h5
            className={classNames(
              projectcss.all,
          ...
          <h5
            className={classNames(projectcss.all, projectcss.h5, sty.h5__vd8H)}
          >
            {renderPlasmicSlot({
