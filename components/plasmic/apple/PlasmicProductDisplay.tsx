...
import sty from "./PlasmicProductDisplay.module.css"; // plasmic-import: oZW2A4uc4WPx/css
...
function PlasmicProductDisplay__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__edgB)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__soEvL, {
            [sty.imgdark__soEvLuuhHe]: hasVariant($state, "dark", "dark"),
            [sty.imgisMobileView__soEvLzf598]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__s8QAe, {
            [sty.imgisMobileView__s8QAeZf598]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bO6D, {
          [sty.freeBoxreverse__bO6DX5WkM]: hasVariant(
            $state,
            "reverse",
            "reverse"
          )
      ...
      >
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__vmSin, {
            [sty.freeBoxdark__vmSinuuhHe]: hasVariant($state, "dark", "dark")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__bnV9X)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__ofDFz)}
                      role={"img"}
                    />
                  }
                  size={"large"}
                ...
                <Button
                  className={classNames("__wab_instance", sty.button__qz6RV)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__dO2G)}
                      role={"img"}
                    />
                  }
                  size={"large"}
