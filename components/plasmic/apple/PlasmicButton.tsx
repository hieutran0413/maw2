...
import sty from "./PlasmicButton.module.css"; // plasmic-import: GfKpHGevupXi/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: RQBuwikoBleW/icon
      ...
      >
        ...
        {(hasVariant($state, "withIcons", "withSuffixIcon") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__uwoWu)}
                  role={"img"}
                />
              ),
