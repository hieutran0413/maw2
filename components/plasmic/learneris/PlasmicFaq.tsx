...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: _r5wwuWadYy2/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___05FBy)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___2TM5H)}>
          <div className={classNames(projectcss.all, sty.freeBox__bamQ)}>
            {renderPlasmicSlot({
