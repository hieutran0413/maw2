...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <LogoIcon
          className={classNames(projectcss.all, sty.svg__zb2D)}
          role={"img"}
        />
      </PlasmicLink__>
      <Stack__
      ...
      >
        <Button
          className={classNames("__wab_instance", sty.button__sJai)}
          color={"clear"}
          link={`/features`}
          size={"compact"}
          submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__r9N6B)}
          color={"clear"}
          link={`/pricing`}
          size={"compact"}
          submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__aEd0L)}
          color={"clear"}
          size={"compact"}
          submitsForm={true}
        >
        ...
        <Button
          className={classNames("__wab_instance", sty.button__a4Aqd)}
          endIcon={
            <RightArrowIcon
              className={classNames(projectcss.all, sty.svg__qpyJb)}
              role={"img"}
            />
          }
          showEndIcon={true}
      ...
      >
        <BrandIcon
          className={classNames(projectcss.all, sty.svg__dulA3)}
          role={"img"}
        />
...
const PlasmicDescendants = {
  ...
  navItems: ["navItems"],
  navButtoons: ["navButtoons", "component1", "signUp", "component2"],
