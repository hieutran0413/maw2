...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: Ag0evssas2_B/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: b5L5VPMAxego/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___4IVub)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qKjZ6)}
        >
          <TextInput
      ...
      <div className={classNames(projectcss.all, sty.freeBox__xUMsP)}>
        <SphereIcon
