...
import BaseCard from "../../BaseCard"; // plasmic-import: Q2DxhMd8kywL/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: xJ57_yvHb6TL/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eAbgf)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__x3B7F)}
        >
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__hPYgl)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__oufMh)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__pOdVv)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__df0NB)}
                />
              </Stack__>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox__gnzQq)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__khWf3)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
